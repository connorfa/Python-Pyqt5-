...
class MainUI(QtWidgets.QMainWindow):
    ...
    def init_ui(self):
        ...
        self.button_1.setText("玩")
        self.button_1.setIcon(QtGui.QIcon('./p1.jpg'))
        self.button_1.setIconSize(QtCore.QSize(30, 30))
        self.button_1.setToolButtonStyle(QtCore.Qt.ToolButtonTextUnderIcon)
        self.right_recommend_layout.addWidget(self.button_1, 0, 0)
        self.right_layout.addWidget(self.right_recommend_label,1,0,1,9)'''
